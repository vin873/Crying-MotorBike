...
def gain_evaluation(individual):
    ...
    Kd_p = (individual[2])/50
    # Kd_p = 1.197
    Kp_e = abs(individual[3])/2
    Ki_e = (individual[4])/100
    Kd_e = (individual[5])/50
...
if __name__ == '__main__':
    ...
    toolbox.register("attr_gene", random.uniform , 0, 15)
    ...
    MUT_PB = 0.165     # mutation probability
